(function () {
    ...
    var shoploopWindow = $(window);

    // :: Preloader
    shoploopWindow.on('load', function () {
    ...
    // :: Dropdown Menu
    $(".sidenav-nav").find("li.shoploop-dropdown-menu").append("<div class='dropdown-trigger-btn'><i class='ti ti-chevron-down'></i></div>");
    ...
    // :: Tooltip 
    var tooltipshoploop = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'))
    var tooltipList = tooltipshoploop.map(function (tooltip) {
        return new bootstrap.Tooltip(tooltip);
    });

    // :: Toast 
    var toastshoploop = [].slice.call(document.querySelectorAll('.toast'));
    var toastList = toastshoploop.map(function (toast) {
